...
const Hero = () => {
  return (
    <section className="relative isolate -mt-20 flex min-h-[85vh] w-full items-start overflow-hidden bg-black pt-20 sm:items-center">
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 md:right-10">
        <a
          href="/shop"
          aria-label="Shop"
          className="flex h-12 w-12 items-center justify-center rounded-full bg-black/80 text-white shadow-lg transition-transform hover:scale-105"
        >
          <CartIcon />
        </a>
        <a
